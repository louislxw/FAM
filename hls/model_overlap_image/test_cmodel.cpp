...
// void model_wrapper(AXIS_IN &axis_image_in, AXIS_OUT &axis_pred_out, ap_int<32> batch_size);
...
int main(int argc, char **argv) {
	...
	ap_int<32> in_size = 64*256; //64*256*64
	// ap_int<32> image_size = 64*64;
	ap_int<32> out_size = 256;
	ap_int<32> batch_size = 1; // 64
    ...
    for (int i = 0; i < out_size*batch_size; i++) {
